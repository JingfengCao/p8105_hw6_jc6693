...
It is approximately bell-shaped with slightly left skewed tail, and almost all r^2 is more than 0.93.
...
```
considering using mother's weight(ppwt) and weight gained (wtgain) and baby's sex(babysex) to predict birthweight(bwt).
